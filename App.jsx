  ...
  if (complete) {
    completeDisplay = (
      <div style={{ padding: 64, backgroundColor: "#eeffef", fontWeight: "bold", color: "rgba(0, 0, 0, 0.85)" }}>
        ...
        <Balance balance={exampleExternalContractBalance} fontSize={64} /> ETH locked!
      </div>
    );
  }
  ...
  */
  ...
  return (
    <div className="App">
      ...
      <div style={{ position: "fixed", textAlign: "right", right: 10, top: 10, padding: 20 }}>
        <Account
          address={address}
      ...
      <div style={{ position: "fixed", textAlign: "left", left: 20, bottom: 20, padding: 20 }}>
